...
<input value="{{ $supplier->locations }}" name="locations" class="form-control @error('locations') is-invalid @enderror" type="text" placeholder="Enter locations Name">
...
<input value="{{ $supplier->products }}" name="products" class="form-control @error('locations') is-invalid @enderror" type="text" placeholder="Enter locations Name">
@error('locations')
<span class="invalid-feedback" role="alert">
<strong>{{ $message }}</strong>
</span>
