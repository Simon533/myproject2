...
<div class="">
<a class="btn btn-primary" href="{{route('supplier.create')}}"><i class="fa fa-plus"> Add <em>new</em> Supplier</i></a>
</div>
...
swal({
title: 'Are you sure?',
text: "You won't be able to see the information about the customer again!",
type: 'warning',
showCancelButton: true,
confirmButtonColor: '#3085d6',
cancelButtonColor: '#d33',
confirmButtonText: 'Yes, delete it dont want it !',
...
swal(
'Cancelled',
'Your information/data is ok now  :)',
'error'
)
}
})
