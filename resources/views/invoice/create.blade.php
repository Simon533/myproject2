...
<div class="app-title">
<div>
<h1><i class="fa fa-edit"></i>Input Invoice</h1>
<p>J&N wholesellers</p>
</div>
<p><marquee> <b>Not yet  complate under contruction</b></marquee></p>
...
<input name="date"  class="form-control datepicker"  value="<?php echo date('Y-m-d')?>" type="date" placeholder="Enter your email here plz ">
</div>
